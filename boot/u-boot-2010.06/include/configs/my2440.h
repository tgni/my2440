...
#define CONFIG_NYX_JS28F32        1        //添加mini2440开发板Nor Flash设置
#define PHYS_FLASH_SIZE            0x400000 //我们开发板的Nor Flash是2M
#define CONFIG_SYS_MAX_FLASH_SECT  (1024)    //根据SST39VF1601的芯片手册描述，对其进行操作有两种方式：块方式和扇区方式。现采用扇区方式(sector)，1 sector = 2Kword = 4Kbyte，所以2M的Nor Flash共有512个sector
